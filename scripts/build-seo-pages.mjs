...
const pages = [
  {
    ...
    description:
      "Roof repairs, new roofs and chimney repointing across North Norfolk — Cromer, Sheringham, Holt, Fakenham and the coast. Free quotes from roofers based in North Norfolk.",
...
function buildPage(page) {
  ...
  const schema = {
    ...
    provider: {
      ...
      email: "enquiries@wbroofing.uk",
      address: {
        "@type": "PostalAddress",
        streetAddress: "81 Cromer Road",
        addressLocality: "Mundesley",
